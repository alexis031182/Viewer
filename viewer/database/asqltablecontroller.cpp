...
// Constructor.
// ========================================================================== //
ASqlTableController::ASqlTableController(QObject *parent) : QObject(parent) {}
...
ASqlTableController::ASqlTableController(const QString &conn_name
    , QObject *parent) : QObject(parent), _conn_name(conn_name) {}
